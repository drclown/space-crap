...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'homesoft_platform_files.remote_scanner' => 'getHomesoftPlatformFiles_RemoteScannerService',
            'homesoft_platform_files.system_scanner' => 'getHomesoftPlatformFiles_SystemScannerService',
            'homesoft_remote_control.omx_reader' => 'getHomesoftRemoteControl_OmxReaderService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'HomesoftPlatformFilesBundle', ($this->targetDirs[2].'/Resources/HomesoftPlatformFilesBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'HomesoftPlatformFilesBundle', ($this->targetDirs[3].'\\src\\Homesoft\\PlatformFilesBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'HomesoftRemoteControlBundle', ($this->targetDirs[2].'/Resources/HomesoftRemoteControlBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'HomesoftRemoteControlBundle', ($this->targetDirs[3].'\\src\\Homesoft\\RemoteControlBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'HomesoftExternalDiskBundle', ($this->targetDirs[2].'/Resources/HomesoftExternalDiskBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'HomesoftExternalDiskBundle', ($this->targetDirs[3].'\\src\\Homesoft\\ExternalDiskBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'HomesoftMediaBundle', ($this->targetDirs[2].'/Resources/HomesoftMediaBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'HomesoftMediaBundle', ($this->targetDirs[3].'\\src\\Homesoft\\MediaBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'space_crap', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Homesoft\\PlatformFilesBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Homesoft\\ExternalDiskBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Homesoft\\MediaBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Homesoft\\PlatformFilesBundle\\Entity');
        $c->addDriver($b, 'Homesoft\\ExternalDiskBundle\\Entity');
        $c->addDriver($b, 'Homesoft\\MediaBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('HomesoftPlatformFilesBundle' => 'Homesoft\\PlatformFilesBundle\\Entity', 'HomesoftExternalDiskBundle' => 'Homesoft\\ExternalDiskBundle\\Entity', 'HomesoftMediaBundle' => 'Homesoft\\MediaBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ff97620e3eb699cfcbf6fee68a43ca48c1d204e5ae887b6effd0b031039f7c18');
    ...
    /**
     * Gets the 'homesoft_platform_files.remote_scanner' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Homesoft\PlatformFilesBundle\services\RemoteScanner A Homesoft\PlatformFilesBundle\services\RemoteScanner instance.
     */
    protected function getHomesoftPlatformFiles_RemoteScannerService()
    {
        return $this->services['homesoft_platform_files.remote_scanner'] = new \Homesoft\PlatformFilesBundle\services\RemoteScanner();
    }

    /**
     * Gets the 'homesoft_platform_files.system_scanner' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Homesoft\PlatformFilesBundle\services\SystemScanner A Homesoft\PlatformFilesBundle\services\SystemScanner instance.
     */
    protected function getHomesoftPlatformFiles_SystemScannerService()
    {
        return $this->services['homesoft_platform_files.system_scanner'] = new \Homesoft\PlatformFilesBundle\services\SystemScanner();
    }

    /**
     * Gets the 'homesoft_remote_control.omx_reader' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Homesoft\PlatformFilesBundle\services\OmxReader A Homesoft\PlatformFilesBundle\services\OmxReader instance.
     */
    protected function getHomesoftRemoteControl_OmxReaderService()
    {
        return $this->services['homesoft_remote_control.omx_reader'] = new \Homesoft\PlatformFilesBundle\services\OmxReader();
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'DoctrineBundle', 5 => 'SensioFrameworkExtraBundle', 6 => 'HomesoftPlatformFilesBundle', 7 => 'AsseticBundle', 8 => 'FOSJsRoutingBundle', 9 => 'HomesoftRemoteControlBundle', 10 => 'HomesoftExternalDiskBundle', 11 => 'HomesoftMediaBundle', 12 => 'DebugBundle', 13 => 'WebProfilerBundle', 14 => 'SensioDistributionBundle', 15 => 'SensioGeneratorBundle', 16 => 'DoctrineFixturesBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Homesoft\\PlatformFilesBundle/Resources/views'), 'HomesoftPlatformFiles');
        $instance->addPath(($this->targetDirs[3].'\\src\\Homesoft\\RemoteControlBundle/Resources/views'), 'HomesoftRemoteControl');
        $instance->addPath(($this->targetDirs[3].'\\src\\Homesoft\\ExternalDiskBundle/Resources/views'), 'HomesoftExternalDisk');
        $instance->addPath(($this->targetDirs[3].'\\src\\Homesoft\\MediaBundle/Resources/views'), 'HomesoftMedia');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('93e923bb67ae1f894ffa07c83f4525dc973f58c9');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5727c0c38a6ae8.31408732')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'HomesoftPlatformFilesBundle' => 'Homesoft\\PlatformFilesBundle\\HomesoftPlatformFilesBundle',
                'AsseticBundle' => 'Symfony\\Bundle\\AsseticBundle\\AsseticBundle',
                'FOSJsRoutingBundle' => 'FOS\\JsRoutingBundle\\FOSJsRoutingBundle',
                'HomesoftRemoteControlBundle' => 'Homesoft\\RemoteControlBundle\\HomesoftRemoteControlBundle',
                'HomesoftExternalDiskBundle' => 'Homesoft\\ExternalDiskBundle\\HomesoftExternalDiskBundle',
                'HomesoftMediaBundle' => 'Homesoft\\MediaBundle\\HomesoftMediaBundle',
            ...
            'tmdb_key' => 'c971d5aa22ac894f5f011b15584d9f78',
            'database_host' => 'localhost',
            'database_port' => NULL,
            'database_name' => 'space_crap',
            'database_user' => 'root',
            'database_password' => NULL,
            'secret' => '93e923bb67ae1f894ffa07c83f4525dc973f58c9',
            'locale' => 'en',
            ...
            'kernel.secret' => '93e923bb67ae1f894ffa07c83f4525dc973f58c9',
            ...
            'assetic.bundles' => array(
                ...
                6 => 'HomesoftPlatformFilesBundle',
                7 => 'AsseticBundle',
                8 => 'FOSJsRoutingBundle',
                9 => 'HomesoftRemoteControlBundle',
                10 => 'HomesoftExternalDiskBundle',
                11 => 'HomesoftMediaBundle',
                12 => 'DebugBundle',
